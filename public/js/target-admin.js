...
var target_admin = function () {
  ...
  function initDatepicker () {
    ...
    $('.ui-datepicker').each(function(){
        if($(this).val() == ''){
          $(this).datepicker ({ autoclose: true,  format: 'dd/mm/yyyy' }).datepicker("setDate", new Date()); 
          var currentDate = new Date();
          $(this).datepicker("setDate", currentDate);
        }

    });  
		/*$('.ui-datepicker').datepicker ({ autoclose: true,  format: 'dd/mm/yyyy' }).datepicker("setDate", new Date()); 
		 var currentDate = new Date();
 		 $(".ui-datepicker").datepicker("setDate", currentDate);*/
	}
  }
